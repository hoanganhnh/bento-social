...
export const ROUTE_MAPPINGS: RouteMapping[] = [
  ...
  {
    path: "/v1/rpc/introspect",
    service: "AUTH",
    targetPath: "/rpc/introspect",
  },
  ...
  // ============ USER SERVICE ============
  {
    ...
    service: "USER",
    targetPath: "/users/suggested",
  },
  {
    path: "/v1/users/:id/saved-posts",
    service: "INTERACTION",
    targetPath: "/users/:id/saved-posts",
  },
  { path: "/v1/users/:id", service: "USER", targetPath: "/users/:id" },
  {
    path: "/v1/rpc/users/by-ids",
    service: "USER",
    targetPath: "/rpc/users/by-ids",
  },
  {
    path: "/v1/rpc/users/find",
    service: "USER",
    targetPath: "/rpc/users/find",
  },
  ...
  // ============ COMMENT SERVICE ============
  {
    ...
    service: "COMMENT",
    targetPath: "/posts/:postId/comments",
  },
  {
    path: "/v1/comments/:id/replies",
    service: "COMMENT",
    targetPath: "/comments/:id/replies",
  },
  ...
  // ============ INTERACTION SERVICE (Like, Save, Follow) ============
  {
    ...
    service: "INTERACTION",
    targetPath: "/posts/:id/like",
  },
  {
    path: "/v1/posts/:id/unlike",
    service: "INTERACTION",
    targetPath: "/posts/:id/unlike",
  },
  {
    path: "/v1/posts/:id/save",
    service: "INTERACTION",
    targetPath: "/posts/:id/save",
  },
  {
    path: "/v1/posts/:id/unsave",
    service: "INTERACTION",
    targetPath: "/posts/:id/unsave",
  },
  {
    path: "/v1/posts/:id/liked-users",
    service: "INTERACTION",
    targetPath: "/posts/:id/liked-users",
  },
  {
    path: "/v1/users/:id/follow",
    service: "INTERACTION",
    targetPath: "/users/:id/follow",
  },
  {
    path: "/v1/users/:id/unfollow",
    service: "INTERACTION",
    targetPath: "/users/:id/unfollow",
  },
  {
    path: "/v1/users/:id/has-followed",
    service: "INTERACTION",
    targetPath: "/users/:id/has-followed",
  },
  {
    path: "/v1/users/:id/followers",
    service: "INTERACTION",
    targetPath: "/users/:id/followers",
  },
  {
    path: "/v1/users/:id/followings",
    service: "INTERACTION",
    targetPath: "/users/:id/followings",
  },
  {
    path: "/v1/rpc/has-liked",
    service: "INTERACTION",
    targetPath: "/rpc/has-liked",
  },
  {
    path: "/v1/rpc/list-post-ids-liked",
    service: "INTERACTION",
    targetPath: "/rpc/list-post-ids-liked",
  },
  {
    path: "/v1/rpc/has-saved",
    service: "INTERACTION",
    targetPath: "/rpc/has-saved",
  },
  {
    path: "/v1/rpc/list-post-ids-saved",
    service: "INTERACTION",
    targetPath: "/rpc/list-post-ids-saved",
  },
  ...
  // ============ UPLOAD SERVICE ============
  { path: "/v1/upload-file", service: "UPLOAD", targetPath: "/upload-file" },
